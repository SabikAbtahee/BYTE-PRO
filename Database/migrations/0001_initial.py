# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-08 09:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skilltag', multiselectfield.db.fields.MultiSelectField(choices=[('C', 'C'), ('C++', 'C++'), ('JAVA', 'JAVA'), ('PYTHON', 'PYTHON'), ('RUBY', 'RUBY'), ('C#', 'C#'), ('FORTRAN', 'FORTRAN'), ('JAVASCRIPT', 'JAVASCRIPT'), ('HTML', 'HTML'), ('CSS', 'CSS')], default='NONE', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Version',
