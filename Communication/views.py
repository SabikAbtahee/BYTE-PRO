...
class Communication(object):
    ...
    def fetchImage(self, request):
        ...
        if(type=="project"):
            ...
            assignDevs = Database.models.AssignDeveloper.objects.filter(project = project)

            for assDev in assignDevs:
                user = assDev.assignDeveloper
                print(user)
                userInformation = Database.models.UserInformation.objects.get(user = user)
                data[assDev.id] = userInformation.profilePicture.url
